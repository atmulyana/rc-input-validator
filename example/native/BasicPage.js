...
const Select = select(), Option = option();
...
const DatePicker = React.memo(function({onChange, style, value, ...props}) {
...
const RadioButtons = React.memo(({inputProps = {}, labelProps = {}, options, value, onPress, style}) =>
    <RadioForm
        formHorizontal={true}
        animation={true}
